...
abstract class Image_Driver {
	...
	/**
	 * Gamma correction of the image. Valid amounts are 0.01 to 5.
	 *
	 * @param   integer  in to inputgamaa
	 * @param	integer	 out to outputgamaa
	 * @return  boolean
	 */
	abstract public function gamma_correction($properties);
} // End Image Driver